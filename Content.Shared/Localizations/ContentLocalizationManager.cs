...
namespace Content.Shared.Localizations
{
    public sealed class ContentLocalizationManager
    {
        ...
        private const string Culture = "ru-RU"; // SpaceFreedom
        private const string FallbackCulture = "en-US"; // SpaceFreedom
        ...
        public void Initialize()
        {
            ...
            var fallbackCulture = new CultureInfo(FallbackCulture); // SpaceFreedom

            _loc.LoadCulture(culture);
            _loc.LoadCulture(fallbackCulture); // SpaceFreedom
            _loc.SetFallbackCluture(fallbackCulture); // SpaceFreedom
            _loc.AddFunction(culture, "MANY", FormatMany); // SpaceFreedom
